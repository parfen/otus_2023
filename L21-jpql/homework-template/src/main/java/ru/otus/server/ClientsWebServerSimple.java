...
//    private final UserDao userDao;
    ...
    public ClientsWebServerSimple(int port, DBServiceClient clientDao, TemplateProcessor templateProcessor) {
    ...
    private ServletContextHandler createServletContextHandler() {
        ...
        servletContextHandler.addServlet(new ServletHolder(new ClientsApiServlet(clientDao)), "/api/client/*");
        return servletContextHandler;
    }
}
